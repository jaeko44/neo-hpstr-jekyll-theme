/********************************************************
 *
 * Custom Javascript code for Coming Soon (VirtEngine)
 * Subsidairy of DET-IO Pty. Ltd.
 *
 *******************************************************/
$(document).ready(function() {
  ...
  $("#getNotified").click(function() {
    $('html, body').animate({scrollTop:$('#newsletter').position().top}, 'slow');
  });
  document.getElementById("viewDocs").onclick = function () {
      location.href = "http://docs.virtengine.com";
  };
  //scheme switcher
  if ($('#schemes').size() > 0) {
